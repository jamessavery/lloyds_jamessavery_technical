package com.example.features.procedures.presentation.ui.screens
...
import com.example.core.presentation.ui.components.ProcedureDetailCard
...
fun ProceduresScreen(
    ...
    Box(
        ...
        if (uiState.isLoading) {
            ...
            Text(
                text = stringResource(com.example.core.R.string.generic_error_message),
