...
import com.example.lloyds_jamessavery_technical.domain.util.TimeDateUtils.Companion.TIMEDATE_STRING_CUTOFF
import com.example.lloyds_jamessavery_technical.domain.util.TimeDateUtils.Companion.OUTPUT_PATTERN
import com.example.lloyds_jamessavery_technical.domain.util.TimeDateUtils.Companion.PATTERN_STRING
